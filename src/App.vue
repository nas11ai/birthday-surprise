...
<template>
  <div class="min-h-screen bg-gradient-to-br from-pink-100 via-pink-50 to-rose-100 relative overflow-hidden">
    ...
    <div v-if="showContent" class="relative z-10">
      ...
      >
        ...
        >
          ...
          <!-- Photo Frame -->
          <PhotoFrame 
            :photo-url="girlfriendPhoto"
            :name="girlfriendName"
          />
          
          <!-- Special message -->
          <div class="mt-12 text-center max-w-lg px-4 animate-fade-in-up" style="animation-delay: 3s;">
    ...
    <div class="fixed top-20 right-20 text-2xl animate-sparkle" style="animation-delay: 0.5s">✨</div>
    <div class="fixed bottom-20 left-20 text-2xl animate-sparkle" style="animation-delay: 1s">✨</div>
    <div class="fixed bottom-10 right-10 text-3xl animate-sparkle" style="animation-delay: 1.5s">✨</div>
  </div>
</template>
